Point-Transformer PyTorch Alternative code 
============================

# This is an Alternative Implemention of Point Transformer from [this really cool repo/lib](https://github.com/POSTECH-CVLab/point-transformer) 
## Thanks to the original authors,this Implemention is clean and cool, I have only done some tweaking for this project. 
